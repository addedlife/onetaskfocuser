import {
  html as html2,
  literal
} from "./chunk-7U5TYVGW.js";
import {
  getFormValue,
  mixinFormAssociated
} from "./chunk-J7RDODWJ.js";
import {
  internals,
  mixinElementInternals
} from "./chunk-T6BSPDLJ.js";
import {
  styleMap
} from "./chunk-AFB46R4D.js";
import {
  redispatchEvent
} from "./chunk-4X3LRXT2.js";
import {
  EASING
} from "./chunk-5W67AO6Y.js";
import {
  mixinDelegatesAria
} from "./chunk-UZ6RZREX.js";
import {
  Directive,
  PartType,
  classMap,
  directive
} from "./chunk-4YBTMTVG.js";
import {
  LitElement,
  _$LH,
  css,
...
var Field = class extends LitElement {
  ...
  render() {
    ...
    const outline = (_a2 = this.renderOutline) == null ? void 0 : _a2.call(this, floatingLabel);
    const classes = {
  ...
  animateLabelIfNeeded({ wasFocused, wasPopulated }) {
    ...
    (_a2 = this.labelAnimation) == null ? void 0 : _a2.cancel();
...
function mixinOnReportValidity(base) {
  ...
  class OnReportValidityElement extends base {
    ...
    [(_a2 = privateCleanupFormListeners, _b2 = privateDoNotReportInvalid, _c = privateIsSelfReportingValidity, privateCallOnReportValidity)](invalidEvent) {
...
var styles4 = css`:host{display:inline-flex;outline:none;resize:both;text-align:start;-webkit-tap-highlight-color:rgba(0,0,0,0)}.text-field,.field{width:100%}.text-field{display:inline-flex}.field{cursor:text}.disabled .field{cursor:default}.text-field,.textarea .field{resize:inherit}slot[name=container]{border-radius:inherit}.icon{color:currentColor;display:flex;align-items:center;justify-content:center;fill:currentColor;position:relative}.icon ::slotted(*){display:flex;position:absolute}[has-start] .icon.leading{font-size:var(--_leading-icon-size);height:var(--_leading-icon-size);width:var(--_leading-icon-size)}[has-end] .icon.trailing{font-size:var(--_trailing-icon-size);height:var(--_trailing-icon-size);width:var(--_trailing-icon-size)}.input-wrapper{display:flex}.input-wrapper>*{all:inherit;padding:0}.input{caret-color:var(--_caret-color);overflow-x:hidden;text-align:inherit}.input::placeholder{color:currentColor;opacity:1}.input::-webkit-calendar-picker-indicator{display:none}.input::-webkit-search-decoration,.input::-webkit-search-cancel-button{display:none}@media(forced-colors: active){.input{background:none}}.no-spinner .input::-webkit-inner-spin-button,.no-spinner .input::-webkit-outer-spin-button{display:none}.no-spinner .input[type=number]{-moz-appearance:textfield}:focus-within .input{caret-color:var(--_focus-caret-color)}.error:focus-within .input{caret-color:var(--_error-focus-caret-color)}.text-field:not(.disabled) .prefix{color:var(--_input-text-prefix-color)}.text-field:not(.disabled) .suffix{color:var(--_input-text-suffix-color)}.text-field:not(.disabled) .input::placeholder{color:var(--_input-text-placeholder-color)}.prefix,.suffix{text-wrap:nowrap;width:min-content}.prefix{padding-inline-end:var(--_input-text-prefix-trailing-space)}.suffix{padding-inline-start:var(--_input-text-suffix-leading-space)}
`;
