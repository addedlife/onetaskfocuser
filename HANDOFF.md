...
Latest: DeskPhone Web parity slice maps full-compose blockers and updates the parity ledger.

```
pending docs: map DeskPhone web full-compose blockers
