...
Latest: DeskPhone Web parity slice adds thread-side dialpad keys and updates the parity ledger.

```
pending feat: DeskPhone web thread-side dialpad keys
