...
Latest: DeskPhone Web parity slice maps log/collapsed call controls and updates the parity ledger.

```
pending docs: map DeskPhone web log and collapsed call controls
