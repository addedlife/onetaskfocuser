...
Latest: DeskPhone Web parity slice maps Contacts tab contact actions and updates the parity ledger.

```
pending docs: map DeskPhone web Contacts tab actions
