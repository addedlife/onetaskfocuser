...
Latest: DeskPhone Web parity slice maps alternate call-row controls and updates the parity ledger.

```
(pending push) docs: map DeskPhone web alternate call row controls
