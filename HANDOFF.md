...
Latest: DeskPhone Web parity slice maps duplicate dialer/contact controls and updates the parity ledger.

```
(pending push) docs: map DeskPhone web duplicate dialer controls
