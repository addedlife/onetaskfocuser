...
Latest: DeskPhone Web parity slice maps duplicate call/dialer controls and updates the parity ledger.

```
(pending push) docs: map DeskPhone web duplicate call controls
