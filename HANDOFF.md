...
Latest: DeskPhone Web parity slice maps contacts/developer/import controls and updates the parity ledger.

```
(pending push) docs: map DeskPhone web shell destination parity
