...
Latest: DeskPhone Web parity slice maps build/call-banner controls and updates the parity ledger.

```
(pending push) docs: map DeskPhone web build and call controls
