...
Latest: DeskPhone Web parity slice maps contact editor and settings-section rows.

```
pending docs: map DeskPhone web contact editor and settings rows
