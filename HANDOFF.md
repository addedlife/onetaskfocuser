...
Latest: DeskPhone Web parity slice adds dialer text handoff and updates the parity ledger.

```
(pending push) feat: DeskPhone web dialer text handoff
