...
Latest: DeskPhone Web parity slice maps duplicate Calls-tab dialpad rows and updates the parity ledger.

```
pending docs: map DeskPhone web duplicate Calls dialpad rows
