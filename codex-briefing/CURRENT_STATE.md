...
- DeskPhone Web parity map review is complete: 199 of 199 action rows reviewed as of 2026-05-06 (129 implemented-web, 64 host-api-needed, 6 native-only, 0 not-yet-reviewed). Latest runtime slices add Settings host-tool buttons, in-browser thread search previous/next navigation, exact-source thread/row action handoffs, contact/Text handoff mapping, and call-history/call-row handoff mapping.
