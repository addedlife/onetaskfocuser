...
- DeskPhone Web parity map review is complete: 199 of 199 action rows reviewed as of 2026-05-06 (99 implemented-web, 94 host-api-needed, 6 native-only, 0 not-yet-reviewed). Latest runtime slices add Settings host-tool buttons and in-browser thread search previous/next navigation.
